...
export function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true)
    try {
      // Use the unified authentication method - register automatically handles login
            ...
            <div className="bg-black/90 border border-green-500/50 rounded-lg p-8 shadow-2xl backdrop-blur-sm">
              ...
              <div className="text-left font-mono text-sm mb-6">
                <div className="text-green-500">
                  <span className="text-green-400">$</span> ./user_create.sh
                </div>
                <div className="text-yellow-400 animate-pulse">
                  <span className="text-green-400">$</span> Generating secure identity...
                </div>
                <div className="text-green-400 animate-pulse">
                  <span className="text-green-400">$</span> Quantum encryption activated
                </div>
                <div className="text-green-400 animate-pulse">
                  <span className="text-green-400">$</span> Access protocols initialized
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="relative">
                  <label className="text-green-400 text-xs font-mono mb-1 block">AGENT_IDENTIFIER</label>
                  <input
                    type="text"
              ...
              <div className="mt-6 text-center">
                <div className="text-green-600 text-xs font-mono">
                  ...
                  <div className="mt-1">Encryption Level: QUANTUM</div>
                  <div className="mt-1">Registration: OPEN</div>
                </div>
              </div>
